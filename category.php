...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .here { background-color: #ff008b; color: whitesmoke; }
  ...
  <body>
            ...
            <li class="nav-item" style="margin-left:2rem;">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  ?><li><a class="dropdown-item <?=($cat == $selectedCategory) ? 'here' : ''?>" href="category.php?category=<?=$cat?>"><?=$cat?></a></li><?php } ?>
                </ul>
              </div>
            </li>
          </ul>
    ...
    <!-- Banner -->
    <div class="container-fluid py-5" style="background-color:whitesmoke;border-bottom:5px solid #ff008b;">
      <div class="container text-center">
        <h1 style="font-size:70px;font-weight:bold;line-height:1.2;">
          <span style="background-color:#ff008b;color:white;padding:5px 20px;border-radius:10px;display:inline-block;"><?=$selectedCategory?></span>
          <br>
          <span style="color:black;">on</span>
          <span style="color:#ff008b;"><img src="assets/profile-pict/1.svg" width="80" style="margin-top:-15px;"> Barbie</span>
          <span style="color:#111827;">Movie!</span>
        </h1>
      </div>
    </div>
    <!-- Banner -->
    ...
    <div class="container py-5">
      ...
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <?php foreach($movies as $movie){ if($movie['category'] == $selectedCategory){ ?>
