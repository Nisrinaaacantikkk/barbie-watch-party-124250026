...
$error = "";
$registeredNames = ["Nisrina", "Ayu", "Wijayanti"];
...
if(isset($_POST['register'])){
  ...
  } else if(in_array($name, $registeredNames)){
    ...
    <div class="container d-flex justify-content-center position-absolute top-50 start-50 translate-middle">
      <div class="card p-3 py-4">
        <div class="text-center">
          ...
          <h3 class="mt-2">REGISTER YOUR ACCOUNT</h3>
          <hr />
          ...
          <form method="POST">
            ...
            <div class="profile mt-3 mb-3" style="text-align:right;">
              <button type="submit" name="register" class="btn px-5 watch">Submit</button>
            </div>
          </form>
          <small>Already have any account? <a href="login.php" style="color:#ff008b;text-decoration:none;">Login here!</a></small>
        </div>
      </div>
    </div>
