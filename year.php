  ...
  <body>
            ...
            <li class="nav-item" style="margin-left:2rem;">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  ?><li><a class="dropdown-item <?=($year == $selectedYear) ? 'here' : ''?>" href="year.php?year=<?=$year?>"><?=$year?></a></li><?php } ?>
                </ul>
              </div>
            </li>
            <li class="nav-item" style="margin-left:2rem;">
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center" style="background-color:whitesmoke;">
      <div class="col-md-6 mx-auto">
        <h1 class="display-3 fw-bold">
          <span style="background-color:#ff008b;color:whitesmoke;"><?=$selectedYear?></span>
          <br/>
          <span style="color:#ff008b;"><img src="assets/profile-pict/1.svg" width="100"/>Barbie</span> Movie!
        </h1>
      </div>
    </div>
    <!-- Banner -->
    ...
    <div class="container py-5">
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <?php foreach($movies as $movie){ if($movie['year'] == $selectedYear){ ?>
