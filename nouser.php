    ...
    <div class="container d-flex justify-content-center position-absolute top-50 start-50 translate-middle">
      <div class="card p-3 py-4">
        <div class="text-center">
          ...
          <h3 class="mt-2">YOU'RE NOT LOGIN YET</h3>
          <hr />
          <small class="mt-4">Ready to bring back your childhood memories?</small>
          <div class="profile mt-3">
            <a href="login.php"><button class="btn px-5 watch">Log In Here</button></a>
          </div>
        </div>
      </div>
    </div>
